...
export class AegisSupporterToken extends ethereum.SmartContract {
  static bind(address: Address): AegisSupporterToken {
    return new AegisSupporterToken("AegisSupporterToken", address);
  }
